<template>
  <section class="bg-white px-[5%] md:px-[10%] md:flex overflow-y-hidden">
    ...
    <div>
      <h1 class="text-3xl font-semibold overflow-y-hidden mx-4 text-left">Lean Fit</h1>
      ...
      <div class="md:flex my-6 min-h-40">
        <div class="md:-48 shadow-lg shadow-gray-300 mx-4 px-6 py-12 h-36 rounded-2xl overflow-y-hidden">
          <h4 class="text-2xl font-bold overflow-y-hidden">15,200+</h4>
          <h4>Downloads</h4>
        </div>
        <div class="md:w-48 shadow-lg shadow-gray-300 mx-4 px-6 py-12 h-36 rounded-2xl overflow-y-hidden">
      ...
      <button class="mx-4 bg-black text-white rounded-full p-3 px-7 font-semibold text-lg">
        Webpage ↗
      </button>
    </div>
