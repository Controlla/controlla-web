<template>
  <section class="bg-white px-[5%] md:px-[10%] md:flex overflow-y-hidden">
    <img format="webp" loading="lazy" src="/img/cano_steel.png" alt="" class="hidden md:inline w-[20vw] h-[25vw]" />
    <div>
    ...
    <div class="flex justify-center"><img format="webp" loading="lazy" src="/img/cano_steel.png" alt="" class="md:hidden w-[90%] p-[5%]" /></div>
  </section>
</template>